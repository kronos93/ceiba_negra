 ...
 */
$config['site_title']                 = "huertoslaceiba.com";       // Site Title, example.com
$config['admin_email']                = "huertosl@huertoslaceiba.com"; // Admin Email, admin@example.com
$config['default_group']              = 'miembro';           // Default group, use name
