...
!function(factory) {
     true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(303), __webpack_require__(304) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
!function(factory) {
     true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(229), __webpack_require__(303), __webpack_require__(304) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
...
var _inputmask = __webpack_require__(361);

var _inputmask2 = _interopRequireDefault(_inputmask);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _inputmask2.default)({ "mask": "999-9999-9999", 'autoUnmask': true }).mask('.cuenta-banco'); /* import '../configs/datatables'; */
/*import AutoNumeric from 'AutoNumeric/dist/AutoNumeric';*/

(0, _inputmask2.default)({ "mask": "9999-9999-9999-9999", 'autoUnmask': true }).mask('.tarjeta');
//OPCIONES DE INGRESO
var opciones_de_ingreso_table = $('#opciones-de-ingreso-table').DataTable({
    "ajax": (0, _util.base_url)() + 'ajax/get_opciones_de_ingreso',
    "columns": [//Atributos para la tabla
    { "data": "id_opcion_ingreso" }, { "data": "nombre" }, {
        "data": "cuenta",
        "render": function render(data, type, full, meta) {
            if (parseInt(data) === 0) {
                return '';
            } else {
                return _inputmask2.default.format(data, { alias: "999-9999-9999" });
            }
        },
        ...
        "render": function render(data, type, full, meta) {
            if (parseInt(data) === 0) {
                ...
                return _inputmask2.default.format(data, { alias: "9999-9999-9999-9999" });
            }
        }
    }, {
        "data": "ingreso",
        ...
        "render": function render(data, type, full, meta) {
            ...
            var btnShowIngresos = '<a href="' + (0, _util.base_url)() + 'registros/ingresos/' + full.nombre.toLowerCase() + '/' + full.id_opcion_ingreso + '" data-index="' + full.id_opcion_ingreso + '" class="btn btn-success btn-sm go-to-ingreso"><i class="fa fa-fw fa-search"></i>Ver detalles de ingreso</a>';
...
!function(factory) {
     true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(229), __webpack_require__(230) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
